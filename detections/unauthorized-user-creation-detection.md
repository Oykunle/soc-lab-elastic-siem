...
## Description
This detection rule identifies execution of the `useradd` command on a Linux system. Attackers often create new user accounts to maintain persistence after gaining access to a system.
